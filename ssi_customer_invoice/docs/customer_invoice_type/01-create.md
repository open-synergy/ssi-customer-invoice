...
3. Fill in the required fields:
   - **Name**: Enter the customer invoice type name.
...
4. Go to the **Accounting** tab and fill in:
   - **Journal**: Select the default journal used when posting a customer invoice of
     this type.
   - **Receivable Account**: Select the default receivable account used when posting a
     customer invoice of this type.
5. Go to the **Product Configuration** tab and set:
   ...
   - **Products**: Only visible when Product Selection Method = **Manual**. Select the
     products allowed on a customer invoice of this type.
...
6. Go to the **Currency Configuration** tab and set:
   ...
   - **Currencies**: Only visible when Currency Selection Method = **Manual**. Select
     the currencies allowed on a customer invoice of this type.
...
7. Go to the **Pricelist Configuration** tab and set:
   ...
   - **Pricelists**: Only visible when Pricelist Selection Method = **Manual**. Select
     the pricelists allowed on a customer invoice of this type.
...
- A new Customer Invoice Type record is created and available for selection as **Type**
